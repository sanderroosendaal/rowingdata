...
- **Recording strategy:** Stroke-boundary (one Record per stroke, **RecordingStrategy** field ID 10 on **Session message** = `RECORDING_STRATEGY_STROKE_BOUNDARY`). See `docs/FIT_EXPORT.md` "Record message frequency" for details.
